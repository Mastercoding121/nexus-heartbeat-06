import "../_runtime.mjs";
import { _ as toCrossJSONStream, a as H3Event, c as attachRouterServerSsrUtils, d as defaultSerovalPlugins, f as createRawStreamRPCPlugin, g as toCrossJSONAsync, h as fromJSON, l as getNormalizedURL, m as makeSerovalPlugin, o as toResponse, p as createSerializationAdapter, s as mergeHeaders, u as getOrigin } from "../_libs/@tanstack/react-start+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-LhY-dMZX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CVanYHCR.mjs"),
		import("./start-DfIJgCOy.mjs"),
